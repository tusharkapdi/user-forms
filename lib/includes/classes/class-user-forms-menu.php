...
class User_Forms_Menu{
    ...
    public function create_dashboard_admin_page()
    {
        ...
        <style>.bluebg{background:royalblue;color:white}.bluebg th{color:white}.unorderlist {margin: 1em 0 1em 1em ;}.unorderlist li{list-style-type: disc;}</style>
        <?php
    }
