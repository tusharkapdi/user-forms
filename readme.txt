...
Author URI: https://amplebrain.com/
Tags: login form, register form, forgot password form, form builder, ajax login
Requires at least: 4.9
Tested up to: 6.7.1
Requires PHP: 7.2
Stable tag: 1.0.0
Plugin URI: https://amplebrain.com/plugins/user-forms
Donate link: https://amplebrain.com/donate/
License: GPLv2 or later
License URI: https://www.gnu.org/licenses/gpl-2.0.html

Basic WordPress user login, register, forgot password from plugin. Build custom registration & login and forgot password forms with ajax effect & more
...
* For help use [wordpress.org](http://wordpress.org/support/plugin/wp-user-forms/)
* Fork or contribute on [Github](https://github.com/tusharkapdi/wp-user-forms/)
* Visit [our website](https://amplebrain.com/plugins/wp-user-forms/) for more
